...
<main>
    <div class="container-fluid px-4">
        ...
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item active"><a href="{{ route('dashboard') }}">Dashboard</a> > <a href="{{ route('peminjaman-barang.index') }}">Data Peminjaman Barang</a> > {{ $title }}</li>
        </ol>
        <div class="card mb-4">
            <div class="card-body">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('peminjaman-barang.store') }}" method="POST" enctype="multipart/form-data">
                  @csrf
